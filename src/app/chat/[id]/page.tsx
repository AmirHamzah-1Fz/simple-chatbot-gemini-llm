...
export default function ChatPage({
  ...
  return (
    <div className="container max-w-3xl mx-auto w-full h-[100dvh] relative">
      {/* Title */}
      <h1 className="text-2xl font-semibold p-4 text-center">{chat.title}</h1>

      {/* Chat Messages */}
      <div className="w-full h-[65dvh] flex flex-col gap-10 px-2 py-6 overflow-y-auto items-stretch">
